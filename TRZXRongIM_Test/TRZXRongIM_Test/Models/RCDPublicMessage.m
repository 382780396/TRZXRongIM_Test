...
//    if ([KPOUserDefaults userId]) {
        NSMutableDictionary *__dic = [[NSMutableDictionary alloc] init];
            // 用户ID
//        if([KPOUserDefaults name]){
//            [__dic setObject:[KPOUserDefaults name] forKey:@"name"];
//        }
//        if([KPOUserDefaults head_img]){
//            [__dic setObject:[KPOUserDefaults head_img] forKey:@"icon"];
//        }
//        if([KPOUserDefaults userId]){
//            [__dic setObject:[KPOUserDefaults userId] forKey:@"id"];
//        }
...
-(NSString *)conversationDigest{
    ...
    // 用户ID
//    if ([self.senderUserInfo.userId isEqualToString:[KPOUserDefaults userId]]) {

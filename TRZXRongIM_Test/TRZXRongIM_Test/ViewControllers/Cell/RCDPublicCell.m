...
-(void)setAutoLayout{
    ...
    if (self.messageDirection == MessageDirection_RECEIVE) {
        ...
        self.bubbleBackgroundView.image = [UIImage imageNamed:@"RCDBusinessCard_message_receive"];
        ...
        self.bubbleBackgroundView.image = [UIImage imageNamed:@"RCDBusinessCard_message_sender"];
        UIImage *image = self.bubbleBackgroundView.image;

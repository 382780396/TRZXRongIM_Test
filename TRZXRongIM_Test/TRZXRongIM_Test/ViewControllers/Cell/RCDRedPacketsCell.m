...
-(void)setAutoLayout{
    ...
    if (self.messageDirection == MessageDirection_RECEIVE) {
        ...
        self.bubbleBackgroundView.image = [UIImage imageNamed:@"RCDRedPackets_Message_Receive"];
        ...
        self.bubbleBackgroundView.image = [UIImage imageNamed:@"RCDRedPackets_Message_Sender"];
        UIImage *image = self.bubbleBackgroundView.image;

...
-(void)setAutoLayout{
    ...
    if (message.collectionPicture) {
        ...
        [self.pictureImage sd_setImageWithURL:[NSURL URLWithString:message.collectionPicture] placeholderImage:[UIImage imageNamed:@"展位图"]];
    }
    ...
    if (self.messageDirection == MessageDirection_RECEIVE) {
        ...
        self.bubbleBackgroundView.image = [UIImage imageNamed:@"RCDCollection_Message_Receive"];
        ...
        self.bubbleBackgroundView.image = [UIImage imageNamed:@"RCDCollection_Message_Sender"];
        UIImage *image = self.bubbleBackgroundView.image;

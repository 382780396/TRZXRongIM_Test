...
-(void)setupUI{
    ...
    switch (self.type) {
        case RCDSelectedViewTypeAddressBook:{
            [self addConstraint];
            _iconImage.image = [UIImage imageNamed:@"RCDSelected_AddressBook"];
            _textLabel.text = @"通讯录";
            _button.tag = 0;
        }
            break;
        case RCDSelectedViewTypeFinancingLoop:{
            [self addConstraint];
            _iconImage.image = [UIImage imageNamed:@"RCDSelected_FinancingLoop"];
            _textLabel.text = @"投融圈";
        ...
        case RCDSelectedViewTypeSubscribe:{
            [self addConstraint];
            _iconImage.image = [UIImage imageNamed:@"RCDSelected_Subscription"];
            _textLabel.text = @"订阅刊";
            _button.tag = 2;
...
//            [self addConstraintAnnouncement];
            [self addConstraint];
            _iconImage.image = [UIImage imageNamed:@"TRAnnouncement_icon"];
            _textLabel.text = @"消息";
            self.redView.hidden = YES;

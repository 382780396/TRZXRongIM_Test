...
#pragma mark - 初始化方法
//+(instancetype)BPHeadViewInitAnimation:(InvestorsBPInfo *)BPInfo{
//    return [[self alloc]initWithBPInfo:BPInfo];
//}

//-(instancetype)initWithBPInfo:(InvestorsBPInfo *)BPInfo{
//
...
//        
//        // 投资人视角
//        if ([BPInfo.createById isEqualToString:[KPOUserDefaults userId]]) {
//            
//            [self.headImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",BPInfo.targetPhoto]] placeholderImage:[UIImage imageNamed:@"展位图"]];
...
//                case 0:
//                    [self.actionButton setImage:[UIImage imageNamed:@"同意查看.png"] forState:UIControlStateNormal];
//                    break;
//                case 1:
//                    [self.actionButton setImage:[UIImage imageNamed:@"同意.png"] forState:UIControlStateNormal];
//                    break;
//                default:
//                    break;
//            }
...
//                    [self.actionButton setImage:[UIImage imageNamed:@"申请.png"] forState:UIControlStateNormal];
//                    break;
//                case 0:
//                    //                        self.BPLabel.text = @"申请中";
//                    [self.actionButton setImage:[UIImage imageNamed:@"申请中.png"] forState:UIControlStateNormal];
//                    break;
//                case 1:
//                    //                        self.BPLabel.text = @"查看";
//                    [self.actionButton setImage:[UIImage imageNamed:@"查看.png"] forState:UIControlStateNormal];
//                    break;
//                case 2:
//                    //                        self.BPLabel.text = @"申请中";
//                    break;
...
//            switch (BPInfo.status.intValue) {
//                case -1:
//                    [self.actionButton setImage:[UIImage imageNamed:@"投递.png"] forState:UIControlStateNormal];
//                    break;
//                case 0:
//                    [self.actionButton setImage:[UIImage imageNamed:@"已投递.png"] forState:UIControlStateNormal];
//                    break;
//                case 1:
//                    [self.actionButton setImage:[UIImage imageNamed:@"已投递.png"] forState:UIControlStateNormal];
//                    break;

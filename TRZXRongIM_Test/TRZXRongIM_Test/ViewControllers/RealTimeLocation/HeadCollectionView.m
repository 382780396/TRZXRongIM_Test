...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self) {
        ...
        [quitButton setImage:[UIImage imageNamed:@"RCDSharedLocation_Clock"] forState:UIControlStateNormal];
        ...
        [backButton setImage:[UIImage imageNamed:@"RCDSharedLocation_Top"] forState:UIControlStateNormal];

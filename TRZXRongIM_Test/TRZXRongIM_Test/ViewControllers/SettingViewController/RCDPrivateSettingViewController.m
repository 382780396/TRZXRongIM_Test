...
@interface RCDPrivateSettingViewController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate,UIActionSheetDelegate>
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:data forKey:[NSString stringWithFormat:@"chatBackImage%@",@""]];// [KPOUserDefaults userId] // 用户ID
...
//    jubao.targetId = self.targetId;
//    jubao.userTitle = self.conversationTitle;
...
//    
//    UIImage *newImage = [photos[0] kipo_imageCompressToTagetSize:CGSizeMake(RC_SCREEN_WIDTH, RC_SCREEN_HEIGHT)];
//    
//    NSData *data = UIImageJPEGRepresentation(newImage, 1);
//    

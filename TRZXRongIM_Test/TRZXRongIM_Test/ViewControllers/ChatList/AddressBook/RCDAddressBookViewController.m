...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0 && !self.selectedPresent) {
        if (indexPath.row == 0) {
            ...
            [cell.imgvAva setImage:[UIImage imageNamed:@"RCDAddressBook_Friend"]];
            ...
            [cell.imgvAva setImage:[UIImage imageNamed:@"RCDAddressBook_group"]];
        }
        return cell;
    }
...
//                    studentPersonal.midStrr = user.userId;
...
//        RCDUserInfo *targetUser = [[RCDataBaseManager shareInstance] getUserByUserId:self.conversationTargetId];
        ...
        // 跳转个人主页
//        PersonalInformationVC * studentPersonal=[[PersonalInformationVC alloc]init];
//        studentPersonal.midStrr = cell.mid;
//        studentPersonal.otherStr = @"1";
//        [self.navigationController pushViewController:studentPersonal animated:true];
    }
}

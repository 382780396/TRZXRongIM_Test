...
//    if (self.userInfo.userId != [KPOUserDefaults userId]) {
//        //跳转个人主页
//        PersonalInformationVC *privatePersonal = [[PersonalInformationVC alloc]init];
//        privatePersonal.midStrr = self.userInfo.userId;
...
- (void)btnConversation:(UIButton *)button{
    // 身份判断
//    if ([self.userInfo.userId isEqualToString:[KPOUserDefaults userId]]) {

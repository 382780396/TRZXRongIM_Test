...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    // 用户ID
//    if (indexPath.section == 0 && (self.OSMessage || [self.group.adminId isEqualToString:[KPOUserDefaults userId]])) {
...
//        }
//        if([self.group.adminId isEqualToString:[KPOUserDefaults userId]]){
...
//    cell.backgroundColor = [UIColor white];
    ...
    // 用户ID
//    NSString *key = [_allKeys objectAtIndex:self.OSMessage || [self.group.adminId isEqualToString:[KPOUserDefaults userId]]?indexPath.section - 1:indexPath.section];
...
-(CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    // 用户ID
//    if(section == 0 && (self.OSMessage || [self.group.adminId isEqualToString:[KPOUserDefaults userId]])){
//        return 0;
//    }
    // 用户ID
//    NSString *key = [_allKeys objectAtIndex:self.OSMessage || [self.group.adminId isEqualToString:[KPOUserDefaults userId]]?section - 1:section];
//    NSArray *arrayForKey = [_allFriends objectForKey:key];
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
    ...
    // 用户ID
//    return self.OSMessage || [self.group.adminId isEqualToString:[KPOUserDefaults userId]]?[_allKeys count] + 1:[_allKeys count];
    return 0;
}
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{
    ...
    // 用户ID
//    if (_allKeys.count == 0 || ((self.OSMessage || [self.group.adminId isEqualToString:[KPOUserDefaults userId]]) && section == 0)) {
//        return nil;
//    }
    // 用户ID
//    NSString *key = [_allKeys objectAtIndex:self.OSMessage || [self.group.adminId isEqualToString:[KPOUserDefaults userId]] ? section - 1 : section];
...
//        }
        ...
        // 用户ID
//        NSString *key = [_allKeys objectAtIndex:[self.group.adminId isEqualToString:[KPOUserDefaults userId]]?indexPath.section - 1:indexPath.section];
//        NSArray *arrayForKey = [_allFriends objectForKey:key];
//        RCDUserInfo *user = arrayForKey[indexPath.row];
//        if(self.callBackUserInfo){
//            self.callBackUserInfo(@[user]);

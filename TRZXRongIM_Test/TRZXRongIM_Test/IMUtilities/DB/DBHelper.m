...
//    }
    if (!databaseQueue) {
        ...
        // 用户ID
//        NSString *dbPath = [documentDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"KipoUserData%@",[KPOUserDefaults userId]]];
